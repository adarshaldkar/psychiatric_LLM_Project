    ...
    if os.path.exists(PROMPT_FILE):
        try:
            ...
            formatting_directive = (
                ...
                "   b) NEVER invent external book titles, author names, or literature citations (e.g. 'Norcross & Wampold', 'Freud 1920', synthetic books) that do NOT exist word-for-word in the provided 📚 LOCAL KNOWLEDGE BASE context.\n"
                "   c) NEVER generate synthetic DOIs (e.g. 10.1016/j.jad.2024.01.012, 10.2196/jmir.12345).\n"
                "   d) NEVER assign a DOI or URL to a different paper title than what is specified in IMMUTABLE TITLE.\n"
                "   e) ONLY cite exact titles, URLs, and publication years that exist word-for-word in the provided IMMUTABLE fields. If no document was retrieved, explicitly state 'Based on general psychiatric principles'.\n"
