...
class AIOrchestrator:
    ...
    async def process_chat_message(
        ...
        # Append last 3 turns with Deep History Sanitization (reduced from 6 to save prompt space)
        raw_history_len = 0
        ...
        # OpenRouter counts total tokens (input + output). We must ensure:
        #   approx_prompt_tokens + max_tokens  <=  OPENROUTER_INPUT_LIMIT
        # We also want at least MIN_OUTPUT_TOKENS for the answer.
